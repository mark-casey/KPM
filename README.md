...
### Install OSes with MAAS
 ...
 - Once the nodes appear in the MAAS interface, you will "Commission", "Acquire", and then "Deploy" them.
   ...
   - _Note on CoreOS_: Custom images seem to not be working in MAAS at the moment. If installing with coreos-install, skip the Deploy stage below them and continue with tagging hosts. CoreOS installation will happen after building and entering the kpm-kolla container.
